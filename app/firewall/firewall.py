...
def _client_rule(action: str, ip: str, mac: str | None = None):
    validate_ip(ip)
    if mac is not None:
        validate_mac(mac)

    args = [
        action, "FORWARD",  # añadir/eliminar regla en la cadena FORWARD
